...
internal class CompilerTest {
    ...
    fun expressionTestEnum(expression: String?, alias: Map<String, String>, expected: List<TestEnum>) {
        assertThat(expression.allByExpression<TestEnum>(alias)).isEqualTo(expected.size == TestEnum.values().size)
        ...
        assertThat(expression.indexOfFirstByExpression<TestEnum>(alias)).isEqualTo(TestEnum.values().indexOf(expected.firstOrNull()))
        assertThat(expression.indexOfLastByExpression<TestEnum>(alias)).isEqualTo(TestEnum.values().indexOf(expected.lastOrNull()))
        if (expected.isEmpty()) {
            assertThrows<NoSuchElementException> {
